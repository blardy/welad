...
from scenario.info import LogInfo
...
def main():
	...
	SCENARS = [LogInfo(), LogonHistory(), RDPHistory(), MaliciousPowerShell(), BITSService(), FailedLogonHistory(), Search(), ProcessTree(), ProcessStat(), LogonStat(), SuspiciousProcess()]
	SCENARS_DICT = {}
